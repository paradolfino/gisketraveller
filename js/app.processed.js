...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _community = __webpack_require__(328);

	var _community2 = _interopRequireDefault(_community);

	var _mykitchen = __webpack_require__(329);

	var _mykitchen2 = _interopRequireDefault(_mykitchen);
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.pages = {
	      ...
	      MyKitchen: _mykitchen2.default,
	      Contact: _contact2.default
	    };

	    //bindings
	    _this.executor = _this.executor.bind(_this); //dispatcher execution function
	  ...
	  _createClass(App, [{
	    key: 'executor',
	    value: function executor(signal, value) {
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { id: 'wrapper-top' },
	          React.createElement(_header2.default, { executor: this.executor }),
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'h4',
	            null,
	            'Velkommen t\xEBl din Hom'
	          ),
	          React.createElement(
	            'p',
	            null,
	            'Giske ar et \xE5land regjer i M\xF8re og Romsdal k\xF6nt\xE5, Norv\xE5j. Regjern l\xE5jer nord-nordvest f\xE5 tovenen f\xE5 \xC5lesund i den tradidjal d\xEBstrikt f\xE5 Sunnm\xF8re. Den Regjer Senter ar Valderhaugstrand. Oder pop\xF8lase sentere ikl\xF8der dene v\xEBlladje f\xE5 Roald (pa Vigra \xE5land) og Alnes og Leitebakk (bod pa God\xF8y \xE5land). Regjern ar part f\xE5 Den \xC5lesund Regjer.'
	          ),
...
/***/ (function(module, exports) {
	...
	var englishP = 'The area around Giske includes deep fjords, alpine mountains, gentle valleys, countless green islands, wide forests, the wild Atlantic coast, impressive mountain roads, numerous lakes, barren mountain plateaus, charming mountain farms, and the highest waterfalls in Norway. ';
	...
	var Community = function (_React$Component) {
	  ...
	  _createClass(Community, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        "div",
	        { id: "page-community", className: "page" },
	        React.createElement(
	          "div",
	          { className: "content" },
	          React.createElement(
	            "h4",
	            null,
	            "Komm\xF8n og Attraktidje"
	          ),
	          React.createElement(
	            "p",
	            null,
	            "Den regjer omking Giske ikl\xF8der dip fjorde, alpine m\xF6nte, gentel vall\xE5jere, mangie grin \xE5lande, lardj foreste, mangie lake, barran m\xF6nt plateale, kiarmer m\xF6nt farme, og den most h\xE5jer vattenfalle i Norv\xE5j."
	          ),
	          React.createElement("div", { className: "card" })
	        )
	      );
...
/***/ (function(module, exports) {
	...
	var MyKitchen = function (_React$Component) {
	  _inherits(MyKitchen, _React$Component);

	  function MyKitchen() {
	    _classCallCheck(this, MyKitchen);

	    return _possibleConstructorReturn(this, (MyKitchen.__proto__ || Object.getPrototypeOf(MyKitchen)).apply(this, arguments));
	  }

	  _createClass(MyKitchen, [{
	    key: 'render',
	    value: function render() {
	      return React.createElement(
	        'div',
	        { id: 'page-mykitchen', className: 'page' },
	        React.createElement(
	          'div',
	          { className: 'content' },
	          React.createElement(
	            'h4',
	            null,
	            'Min K\xEBtkien (My Kitchen)'
	          ),
	          React.createElement(
	            'p',
	            null,
	            'In a production App, this would obviously say something else. However, I am trying to stay as close to the homework instructions as possible. By the way, if you can\'t see the image for some reason, my favorite place to eat is ',
	            React.createElement(
	              'strong',
	              null,
	              'Sarku Japan'
	  ...
	  _createClass(Contact, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      $("#contactme").click(function (e) {
	        e.preventDefault();
	        var contactDate = Date.now().toString();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _headerNavigation = __webpack_require__(332);
	...
	var Header = function (_React$Component) {
	  ...
	  function Header(props) {
	    ...
	    _this.dispatcher = _this.dispatcher.bind(_this); //dispatcher sends a command from descendant components to main app component
	    return _this;
	  }

	  _createClass(Header, [{
	    key: 'dispatcher',
	    value: function dispatcher(signal, value) {
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(_headerNavigation2.default, { dispatcher: this.dispatcher })
	        )
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _navigation_button = __webpack_require__(333);

	var _navigation_button2 = _interopRequireDefault(_navigation_button);
	...
	var Navigation = function (_React$Component) {
	  ...
	  _createClass(Navigation, [{
	    ...
	    value: function handleClick(e) {
	      ...
	      var signal = 'SIGNAL_NAVIGATE';
	      var value = page; //set value to whatever value you're sending with the signal
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(_navigation_button2.default, { onClick: this.handleClick, value: 'Index', text: 'Hom', fa: 'home' }),
	        React.createElement(_navigation_button2.default, { onClick: this.handleClick, value: 'Community', text: 'Komm\xF8n', fa: 'users' }),
	        React.createElement(_navigation_button2.default, { onClick: this.handleClick, value: 'MyKitchen', text: 'Min K\xEBtkien', fa: 'cutlery' }),
	        React.createElement(_navigation_button2.default, { onClick: this.handleClick, value: 'Contact', text: 'Kontakter', fa: 'envelope' })
	      );
	    }
	  }]);
...
/***/ (function(module, exports) {
	...
	function Button(props) {
	  return React.createElement(
	    "button",
	    { id: 'btn' + props.value, onClick: props.onClick, value: props.value },
	    React.createElement("i", { className: "fa fa-" + props.fa, "aria-hidden": "true" }),
	    "|",
	    props.text
	  );
	}
